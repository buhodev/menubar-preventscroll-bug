...
.trigger {
    ...
    @apply text-blue-900 transition-colors hover:bg-white/90 data-[highlighted]:outline-none;
    @apply overflow-visible data-[highlighted]:bg-blue-200 data-[highlighted]:ring-blue-400 !important;
